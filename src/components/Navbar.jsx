...
function Navbar() {
    return (
        <div className='pr-[30px] pt-[10px] pl-[30px] pb-[10px] flex justify-between shadow-[0px_8px_8px_-12px_rgba(0,0,0,0.75)]'>
            <div className='flex items-center'>
                <span className='font-[500] mr-[15px]'>Payments</span>
                ...
                <small className='font-[400] text-[gray] ml-[6px]'>How it works</small>
            </div>
            <div className='px-4 py-[9px] bg-[#F2F2F2] space-x-2 flex items-center rounded-md w-[500px]'>
